...
static TristateTile? GetTile(Tile currentPosition, Orientation orientation, TileWorld tileWorld)
{
    ...
    //if (potentialNewX > tileWorld.MaxX)
    //    potentialNewX = 0;
    //if (potentialNewX < tileWorld.MinX)
    //    potentialNewX = tileWorld.MaxX;

    //if (potentialNewY > tileWorld.MaxY)
    //    potentialNewY = 0;
    //if (potentialNewY < tileWorld.MinY)
    //    potentialNewY = tileWorld.MaxY;
